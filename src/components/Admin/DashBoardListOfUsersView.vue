    ...
    <div class="body">
      ...
      <div class="row trans-mgt">
        <div class="form-group fg--search">
          ...
          <input type="text" class="input" v-model="searchQuery" placeholder="Search Requests List..." @input="search"/>
        </div>
...
export default {
  ...
  async created() {
    ...
    const querySnapshot2 = await getDocs(collection(db, "Requests"));
    querySnapshot2.forEach((doc) => {
      let data = {
        'fullName': doc.data().fullName,
        'email': doc.data().email,
        'gender': doc.data().gender,
        'request': doc.data().lookingFor,
        'age': doc.data().age,
