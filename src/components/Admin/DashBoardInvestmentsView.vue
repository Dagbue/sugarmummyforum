    ...
    <div class="body">
      ...
      <div class="row trans-mgt">
        <div class="form-group fg--search">
          ...
          <input type="text" class="input" v-model="searchQuery" placeholder="Search Messages..." @input="search"/>
        </div>
...
export default {
  ...
  methods: {
    ...
    async update() {
      ...
      const docRef = doc(db, "SupportRequest", this.SelectEmail);
      try {
  ...
  async created() {
    ...
    const querySnapshot2 = await getDocs(collection(db, "SupportRequest"));
